...
import './App.css';
import { Row, Col, Collapsible, CollapsibleItem, Navbar, Table } from 'react-materialize';
  ...
  return (
    <div className="App">
      <Navbar brand={ 
        ...
        <span className="brand" id="t-name">
           Tressa Ries
        </span>  
        } 
        fixed={true}
        ...
        <br></br>    
        <Row>
          <Col s={12} className="clarkson-symbol" id="clarkson-logo">
          </Col>
        </Row>
        ...
        <Collapsible popout>
            ...
            <CollapsibleItem header="Why Clarkson" icon="done_outline">
              <Table className="table_class">
